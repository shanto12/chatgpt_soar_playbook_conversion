...
def fb_get_something(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.format(container=container, template=template, parameters=parameters, name="fb_get_something", separator=", ")
...
def fl_filter_block_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    if matched_artifacts_1 or matched_results_1:
        fb_get_something(action=action, success=success, container=container, results=results, handle=handle, custom_function=custom_function, filtered_artifacts=matched_artifacts_1, filtered_results=matched_results_1)
...
def getting_some_data(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    # collect data for 'getting_some_data' call
    formatted_data_1 = phantom.get_format_data(name='fb_get_something')

    parameters = []
    
    # build parameters list for 'getting_some_data' call
    parameters.append({
    ...
    phantom.act(action="get data", parameters=parameters, assets=['http'], name="getting_some_data")
